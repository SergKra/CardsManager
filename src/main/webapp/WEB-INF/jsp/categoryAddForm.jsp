...
<div class="container">
    <h2><spring:message code="user.addCategory"/></h2>
    <form:form class="form-horizontal" modelAttribute="category" method="post" action="${pageContext.request.contextPath}/category/add">
