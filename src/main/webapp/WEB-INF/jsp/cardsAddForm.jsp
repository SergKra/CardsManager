...
<div class="container">
    <h2><spring:message code="user.addCard"/></h2>
    <form:form class="form-horizontal" modelAttribute="card" method="post" action="${pageContext.request.contextPath}/cards/add">
